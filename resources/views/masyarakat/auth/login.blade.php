          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukan nik & password to login</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="{{ route('login.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="nik" class="form-control" id="yourUsername" required autofocus>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Bye me</a>
              </div>
