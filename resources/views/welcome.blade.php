...
<html lang="en">
  <head>
    ...
    -->
    <title>Pengaduan Masyarakat Ciomas</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target="#ftco-navbar" data-offset="200">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        <a class="navbar-brand" href="index.html">Ngadu Mas</a>
    ...
    <section class="ftco-cover ftco-slant" style="background-image: url(template/images/bg_3.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center ftco-vh-100">
          <div class="col-md-10">
            <h1 class="ftco-heading ftco-animate">Pengaduan Desa Ciomas</h1>
            {{-- <h2 class="h5 ftco-subheading mb-5 ftco-animate">A free template by <a href="#">Free-Template.co</a></h2>     --}}
            <p><a href="{{ route('login') }}" target="_blank" class="btn btn-primary ftco-animate">Lapor!</a></p>
          </div>
        </div> 
      </div>
    </section>
    ...
    <section class="ftco-section ftco-slant ftco-slant-light">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center ftco-animate">
            <h2 class="text-uppercase ftco-uppercase">Alur Sistem </h2>
            <div class="row justify-content-center mb-5">
              <div class="col-md-7">
                <p class="lead"></p>
              </div>
            ...
            <div class="owl-carousel ftco-owl">
              ...
              <div class="item ftco-animate">
                <div class="media d-block text-left ftco-media p-md-5 p-4">
                  ...
                  <div class="media-body">
                    <h5 class="mt-0">Tulis Laporan</h5>
              ...
              <div class="item ftco-animate">
                <div class="media d-block text-left ftco-media p-md-5 p-4">
                  ...
                  <div class="media-body">
                    <h5 class="mt-0">Proses Verifikasi</h5>
              ...
              <div class="item ftco-animate">
                <div class="media d-block text-left ftco-media p-md-5 p-4">
                  ...
                  <div class="media-body">
                    <h5 class="mt-0">Beri Tanggapan</h5>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12 text-center ftco-animate">
            ...
            <div class="row justify-content-center mb-5">
              <div class="col-md-7">
                <p class="lead">Jumlah keluh kesah semua warga desa ciomas</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md ftco-animate">
            <div class="ftco-counter text-center">
              <span class="ftco-number" data-number="{{ $jmlh_pengaduan }}">0</span>
              <span class="ftco-label">Laporan</span>
            </div>
          </div>
          <div class="col-md ftco-animate">
            <div class="ftco-counter text-center">
              <span class="ftco-number" data-number="{{ $jmlh_tanggapan }}">0</span>
              <span class="ftco-label">Tanggapan</span>
            </div>
          </div>
          {{-- <div class="col-md ftco-animate">
            <div class="ftco-counter text-center">
